Feature: Create a comercial account and provide drugs to DrugDrop
    ...
    When I navigate to register 'http://localhost:9015/registerStore'
    ...
    And I am redirected to "http://localhost:9015/" to Login
    And I set the Email as "store4@store.pt"
    And I set the Password as "store4"
    And I click on the login button
    Then I should see be redirected to "http://localhost:9015/storeIndex"

    Scenario: Provide drugs to DrugDrop
    When I navigate to login "http://localhost:9015/"
    And I set the Email as Admin "store1@store.pt"
    And I set the Password as Admin "store1"
    And I click on the Login button
    And I should see be redirected back to "http://localhost:9015/storeIndex"
    ...
    And I click on the Add New Drug button
    And I should see be redirected back to "http://localhost:9015/storeIndex"
    Then I should see "Pantropazol" on the table of the provided drugs
